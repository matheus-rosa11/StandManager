...
const TRANSLATIONS: Record<LanguageCode, TranslationDictionary> = {
  'pt-BR': {
    ...
    'adminPastels.title': 'Cadastro de sabores de pastel',
    'adminPastels.subtitle': 'Monte uma lista de sabores para registrar de uma só vez e confirme antes de enviar.',
    'adminPastels.addFlavor': 'Adicionar sabor',
    'adminPastels.removeFlavor': 'Remover sabor',
    'adminPastels.nameLabel': 'Nome do sabor',
    'adminPastels.descriptionLabel': 'Descrição (opcional)',
    'adminPastels.imageLabel': 'Link da imagem (opcional)',
    'adminPastels.quantityLabel': 'Quantidade disponível',
    'adminPastels.priceLabel': 'Preço (R$)',
    'adminPastels.reviewButton': 'Revisar cadastro',
    'adminPastels.reviewTitle': 'Revise os sabores antes de confirmar',
    'adminPastels.reviewDescription': 'Confira os dados dos sabores cadastrados e confirme para registrar no sistema.',
    'adminPastels.reviewQuantity': 'Quantidade',
    'adminPastels.reviewPrice': 'Preço',
    'adminPastels.editButton': 'Editar pedido',
    'adminPastels.confirmButton': 'Confirmar cadastro',
    'adminPastels.submitting': 'Registrando...',
    'adminPastels.validationItems': 'Adicione pelo menos um sabor para continuar.',
    'adminPastels.validationName': 'Informe o nome do sabor.',
    'adminPastels.validationDuplicate': 'Já existe um sabor com o nome {{name}} na lista.',
    'adminPastels.validationQuantity': 'Informe uma quantidade válida (zero ou mais).',
    'adminPastels.validationPrice': 'Informe um preço válido para o sabor.',
    'adminPastels.success': '{{count}} sabor cadastrado com sucesso.',
    'adminPastels.success_plural': '{{count}} sabores cadastrados com sucesso.',
    'adminPastels.successItem': '{{name}} — {{quantity}} unidades',
    'adminPastels.error': 'Não foi possível registrar os sabores. Tente novamente.',
  ...
  'en-US': {
    ...
    'adminPastels.title': 'Register pastel flavors',
    'adminPastels.subtitle': 'Prepare a batch of flavors, review the details, and confirm before saving.',
    'adminPastels.addFlavor': 'Add flavor',
    'adminPastels.removeFlavor': 'Remove flavor',
    'adminPastels.nameLabel': 'Flavor name',
    'adminPastels.descriptionLabel': 'Description (optional)',
    'adminPastels.imageLabel': 'Image link (optional)',
    'adminPastels.quantityLabel': 'Available quantity',
    'adminPastels.priceLabel': 'Price (BRL)',
    'adminPastels.reviewButton': 'Review batch',
    'adminPastels.reviewTitle': 'Review the flavors before confirming',
    'adminPastels.reviewDescription': 'Double-check the flavors that will be created and confirm to save them.',
    'adminPastels.reviewQuantity': 'Quantity',
    'adminPastels.reviewPrice': 'Price',
    'adminPastels.editButton': 'Edit order',
    'adminPastels.confirmButton': 'Confirm registration',
    'adminPastels.submitting': 'Saving...',
    'adminPastels.validationItems': 'Add at least one flavor to continue.',
    'adminPastels.validationName': 'Provide the flavor name.',
    'adminPastels.validationDuplicate': 'There is already a flavor named {{name}} in this list.',
    'adminPastels.validationQuantity': 'Enter a valid quantity (zero or more).',
    'adminPastels.validationPrice': 'Enter a valid price for the flavor.',
    'adminPastels.success': '{{count}} flavor registered successfully.',
    'adminPastels.success_plural': '{{count}} flavors registered successfully.',
    'adminPastels.successItem': '{{name}} — {{quantity}} units',
    'adminPastels.error': 'We could not register the flavors. Please try again.',
  ...
  'es-ES': {
    ...
    'adminPastels.title': 'Registrar sabores de pastel',
    'adminPastels.subtitle': 'Prepara un lote de sabores, revísalos y confirma antes de guardarlos.',
    'adminPastels.addFlavor': 'Agregar sabor',
    'adminPastels.removeFlavor': 'Eliminar sabor',
    'adminPastels.nameLabel': 'Nombre del sabor',
    'adminPastels.descriptionLabel': 'Descripción (opcional)',
    'adminPastels.imageLabel': 'Enlace de la imagen (opcional)',
    'adminPastels.quantityLabel': 'Cantidad disponible',
    'adminPastels.priceLabel': 'Precio (BRL)',
    'adminPastels.reviewButton': 'Revisar registro',
    'adminPastels.reviewTitle': 'Revisa los sabores antes de confirmar',
    'adminPastels.reviewDescription': 'Verifica la información de los sabores y confirma para guardarlos.',
    'adminPastels.reviewQuantity': 'Cantidad',
    'adminPastels.reviewPrice': 'Precio',
    'adminPastels.editButton': 'Editar pedido',
    'adminPastels.confirmButton': 'Confirmar registro',
    'adminPastels.submitting': 'Guardando...',
    'adminPastels.validationItems': 'Agrega al menos un sabor para continuar.',
    'adminPastels.validationName': 'Indica el nombre del sabor.',
    'adminPastels.validationDuplicate': 'Ya existe un sabor llamado {{name}} en la lista.',
    'adminPastels.validationQuantity': 'Ingresa una cantidad válida (cero o más).',
    'adminPastels.validationPrice': 'Ingresa un precio válido para el sabor.',
    'adminPastels.success': '{{count}} sabor registrado con éxito.',
    'adminPastels.success_plural': '{{count}} sabores registrados con éxito.',
    'adminPastels.successItem': '{{name}} — {{quantity}} unidades',
    'adminPastels.error': 'No pudimos registrar los sabores. Inténtalo de nuevo.',
