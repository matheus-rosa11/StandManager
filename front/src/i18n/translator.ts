...
const TRANSLATIONS: Record<LanguageCode, TranslationDictionary> = {
  'pt-BR': {
    ...
    'orderStatus.outForDelivery': 'Em rota',
    ...
    'customerOrders.notificationOutForDelivery': 'O pedido {{order}} saiu para entrega! 🚚',
    'volunteer.orderTotal': 'Valor do pedido: {{value}}',
    'volunteerHistory.title': 'Histórico de pedidos',
    'volunteerHistory.subtitle': 'Acompanhe a linha do tempo de cada pedido já concluído.',
  ...
  'en-US': {
    ...
    'customerOrders.notificationOutForDelivery': 'Order {{order}} is out for delivery! 🚚',
    'volunteer.orderTotal': 'Order amount: {{value}}',
    'volunteerHistory.title': 'Order history',
    'volunteerHistory.subtitle': 'Review the timeline of every completed order.',
  ...
  'es-ES': {
    ...
    'customerOrders.notificationOutForDelivery': '¡El pedido {{order}} está en camino! 🚚',
    'volunteer.orderTotal': 'Valor del pedido: {{value}}',
    'volunteerHistory.title': 'Historial de pedidos',
    'volunteerHistory.subtitle': 'Consulta la línea de tiempo de cada pedido finalizado.',
